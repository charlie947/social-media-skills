...
| [`foundations/voice-profile-sal-v2.md`](foundations/voice-profile-sal-v2.md) | **The canonical, deep voice profile** — samples, openers/closers, signature artifact formats, the agent system prompt and output checklist | Any substantial writing task (posts, artifacts, scripts) |
| [`foundations/anti-ai-writing-style.md`](foundations/anti-ai-writing-style.md) | Field guide to AI writing tells. The blacklist of patterns to scrub | Before shipping any written copy |
...
| [`foundations/claude-prompting-cookbook.md`](foundations/claude-prompting-cookbook.md) | Prompting best practices | When building image/video prompts or chaining a complex task |

`about-me.md` and `voice.md` are the quick reference every skill auto-loads (they live at
the repo root because the skills look for them there). `foundations/voice-profile-sal-v2.md`
